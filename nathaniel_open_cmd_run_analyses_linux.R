...
taxon_folder <- paste0("/home/enc001/Documents/Nathaniel/data/", taxon_group)
# map equation...
map_equation_install_folder <- "/home/enc001/Documents/Nathaniel/map_equation/Infomap/Infomap.exe"
...
# modularity equation...
modularity_install_folder <- "/home/enc001/Documents/Nathaniel/netcarto_cl/"
...
#   print(paste0(file_prefix, " ", file_list))
  ...
  sink(paste(taxon_group, "network_analysis_run_stats.txt", sep=""), append=TRUE)
  cat("\n")
